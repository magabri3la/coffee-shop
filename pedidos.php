    ...
    <section>
        <div class="contenedor">
            ...
            <?php require("config/conexion.php");
                ...
                <div class="card" id="<?php echo $resultado["IdProducts"] ?>" >
                    ...
                    <div class="card-footer">
                        ...
                        <div class="card-button" onclick="guardarDatos('<?php echo $resultado["IdProducts"]; ?>', '<?php echo $resultado["ProductName"]; ?>', '<?php echo $resultado["Price"]; ?>')" >
            ...
            <script>
                    ...
                    function guardarDatos(id, name, price) {
                        datosSeleccionados.id = id;
                        datosSeleccionados.name = name;
                        datosSeleccionados.price = price;

                        let elementosGuardados = JSON.parse(localStorage.getItem('carrito')) || [];

                        // Añade el nuevo elemento al array de elementos guardados
                        elementosGuardados.push(datosSeleccionados);

                        // Guarda el array actualizado en el local storage
                        localStorage.setItem('carrito', JSON.stringify(elementosGuardados));

                        console.log('click', JSON.parse(localStorage.getItem('carrito')));
                    }
            </script>
            </div>
        </div>
...
<script src="assets/js/scripts.js"></scrip>
</html>